...
; This is similar to 2.61, but here we look for the weight of a leaf or tree to
; create our set
...
; This will take in a list of symbol-frequency pairs such as:
; ((A 4) (B 2) (C 1) (D 1))
; and constructs an initial ordered set of leaves, ready to be merged according
